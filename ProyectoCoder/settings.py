...
SECRET_KEY = 'django-insecure-j^fo8=qj%$wppigbc+q(7)9fp)ee2y3gxumeqlw6+m32j%bin('
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'ProyectoCoder34645/AppCoder/templates/AppCoder')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_TMP = os.path.join(BASE_DIR, 'static_tmp')
